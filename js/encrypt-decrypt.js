...
async function encryptfile() {
	...
	var fileName = fileTimestamp.getHours()+"-"+fileTimestamp.getMinutes()+"-"+fileTimestamp.getSeconds()+"_"+fileTimestamp.getDate()+"-"+(fileTimestamp.getMonth()+1)+"-"+fileTimestamp.getFullYear()+"_" + objFile.name + '.enc';
